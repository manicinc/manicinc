...
// Performance-optimized version of HeroSection
// V9 - Definitive Quote Fix (useEffect depends only on mount) + V6 Styles + Performance Optimizations
...
import { ArrowRight, ArrowUpRight, Rabbit, ArrowUp, FileText, FolderGit2, RefreshCw } from 'lucide-react';
...
const AsciiArtPlaceholder = dynamic(() => import("../lib/asciiPlaceholders"), { ssr: false });
                                                ...
                                                {item.image ? (
                                                  <div className="card-image-wrapper">
                                                    <Image
                                                      ...
                                                      width={400}
                                                      height={300}
                                                      sizes="(max-width: 480px) 33vw, (max-width: 768px) 33vw, (max-width: 1024px) 25vw, 400px"
                                                      quality={85}
                                                    />
