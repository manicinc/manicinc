...
// Note: SEO metadata is handled by the layout or parent components
...
const UsaMapHighlightSVG = ({ className = "" }: { className?: string }) => (
    <svg
        ...
        className={`w-full max-w-lg h-auto mx-auto ${className}`}
    >
        ...
        <g filter="url(#mapWobble)">
            ...
            <path
                d="M118 237 L113 245 L105 253 L97 260 L90 268 L87 278 L85 288 L82 298 L80 308 L78 318 L76 328 L74 338 L72 348 L70 358 L70 368 L70 378 L73 388 L76 398 L81 406 L90 418 L98 427 L106 435 L114 441 L122 446 L127 452 L130 460 L133 468 L136 476 L139 484 L142 492 L145 500 L148 508 L151 516 L154 524 L157 532 L160 540 L163 548 L166 556 L169 564 L171 570 L172 574 L172 578 L170 582 L167 586 L164 590 L161 594 L158 598 L155 598 L152 594 L149 590 L146 586 L143 582 L140 578 L137 574 L134 570 L131 566 L128 562 L125 558 L122 554 L119 550 L116 546 L113 542 L110 538 L107 534 L104 530 L101 526 L98 522 L95 518 L92 514 L89 510 L86 506 L83 502 L80 498 L77 494 L74 490 L71 486 L68 482 L65 478 L62 474 L59 470 L56 466 L53 462 L50 458 L47 454 L44 450 L41 446 L38 442 L35 438 L32 434 L29 430 L26 426 L23 422 L20 418 L25 420 L30 422 L35 424 L40 426 L45 428 L50 430 L55 432 L60 434 L65 436 L70 438 L75 440 L80 442 L85 444 L90 446 L95 448 L100 450 L105 452 L110 454 L115 456 L120 458 L125 460 L130 462 L135 464 L140 466 L145 468 L148 473 L146 479 L144 485 L142 491 L140 497 L138 503 L136 509 L134 515 L132 521 L130 527 L128 533 Z"
...
const ThreeBodyNexusSVG = ({ className = "" }: { className?: string }) => (
    <svg
        viewBox="0 0 300 200"
        xmlns="http://www.w3.org/2000/svg"
        className={`w-full max-w-md h-auto mx-auto ${className}`}
    >
        ...
        <style>
            {`
                ...
                .orbital-path-slow {
                    ...
                    animation: dash-flow-3body 15s linear infinite reverse;
                }
        ...
        <g filter="url(#etherWobble)">
            ...
            <g>
                <path d="M220,60 C280,120 150,180 70,130 S180,-20 220,60 Z"
                    stroke="var(--accent-highlight)" strokeWidth="1.5" fill="none" opacity="0.8"
...
const AbstractUsaMapSVG = ({ className = "" }: { className?: string }) => (
    <svg
        viewBox="0 0 300 180"
        xmlns="http://www.w3.org/2000/svg"
        className={`w-full max-w-xl h-auto mx-auto ${className}`}
    >
        ...
        <style>
            {`
                ...
                .abstract-pin-glow {
                    animation: pulseGlowAbstract 2s infinite ease-in-out alternate;
                     transform-origin: center;
                }
                .network-line {
...
const executives = [
    ...
    { id: 'victor', name: 'Victor E.', title: 'Core Developer', emoji: '🐻‍❄️', description: 'Full-stack software developer hailing from Nigeria with a potent blend of skills in blockchain engineering, AI implementation, social integrations, and captivating digital illustration & animation.', icon: <BrainCircuit size={18} /> },
    { id: 'godwin', name: 'Godwin', title: 'Junior Marketer', emoji: '🦋', description: 'Slowly but surely forging their mark in the digital marketing world, Godwin is becoming a staple in web3 communities globally, and a master of managing social media content.', icon: <BrainCircuit size={18} /> },
];
    ...
    return (
        <div className={`min-h-screen ${styles.pageWrapper}`}>
            <main className={styles.contentContainer}>
                ...
                <section className={`py-12 md:py-16 lg:py-20 ${styles.documentSection}`}>
                <div className="container mx-auto px-4">
                    ...
                    <motion.div
                        className={styles.locationAsciiWrapper}
                        initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }}
                        viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.5 }}
                    >
                        <ThreeBodyNexusSVG className={styles.locationMapSvg} />
