...
const executives = [
    ...
    { id: 'victor', name: 'Victor Evogor', title: 'Software Engineer', emoji: '🐺', description: 'Building at the intersection of web3 infrastructure and autonomous AI systems. Fluent in smart contracts, decentralized protocols, and the kind of full-stack sorcery that makes on-chain intelligence feel seamless. Shipping code that thinks for itself.', icon: <GitBranch size={18} /> },
