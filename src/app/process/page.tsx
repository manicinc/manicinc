                  ...
                  <section className={`py-10 md:py-12 lg:py-16 bg-gradient-to-br from-[--bg-secondary]/10 via-[--bg-secondary]/30 to-[--bg-secondary]/10 ${styles.documentSection}`}>
                      <div className="container mx-auto px-4">
                          <div className="md:grid md:grid-cols-2 md:gap-12 lg:gap-20 items-center"> {/* Increased gap */}
                              ...
                              >
                                  <motion.h3 variants={fadeIn} className={`${styles.sectionTitle} !text-2xl md:!text-3xl !mb-4 text-left`}>The &lsquo;Mania&rsquo; Method</motion.h3>
                                  ...
                                  <motion.p variants={fadeIn} className="text-base md:text-lg text-[--text-muted] mb-6 leading-relaxed"> {/* Adjusted spacing */}
                                      This &lsquo;manic&rsquo; intensity, channeled through the Blueprint, cultivates emergent strategies and creative breakthroughs while rigorously maintaining project velocity and architectural soundness. We synthesize complexity into clarity, materializing the future, <strong>faster and smarter</strong>.
                                  </motion.p>
